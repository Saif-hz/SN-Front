...
export const MoonIcon = ({ color = "#FFF" }: { color?: string }) => (
  //   <Svg width={38} height={50} viewBox="0 0 553 510" fill="none">
  <Svg width="35" height="61" viewBox="0 0 75 61" fill="none">
    <Path
      fill-rule="evenodd"
      clip-rule="evenodd"
      d="M0 0L15.9661 60.2858H74.6855C39.8586 56.4053 11.0551 32.3688 0 0Z"
      fill={color}
    />
  </Svg>
);
